		...
		if (Pt1.poly.size()==3)
		{
		 ...
		 if (Pt.poly.size()==1 && Pt.poly[0].coef!=0)
		  ...
		  if (Pt.poly.size()==2  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0)
			...
			if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 && Pt.poly[1].coef!=0))
			{
				str=CoefFact(Pt.poly[1].coef)+expow(Pt.poly[1].airx)+expox(Pt.poly[1].periy)+"y"+expoz(Pt.poly[1].feuillez)+expot(Pt.poly[1].compconn);
			}
			if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 && Pt.poly[1].coef==0)){
				str="0";
			}
		 ...
		 if (Pt.poly.size()==3  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0 && Pt.poly[2].coef!=0)
			...
			if (Pt.poly.size()==3 && (Pt.poly[0].coef==0 && Pt.poly[1].coef==0) &&  Pt.poly[2].coef!=0)
			{
				str=CoefFact(Pt.poly[2].coef)+expow(Pt.poly[2].airx)+expox(Pt.poly[2].periy)+"y"+expoz(Pt.poly[2].feuillez)+expot(Pt.poly[2].compconn);
			}
			if (Pt.poly.size()==3 && (Pt.poly[0].coef==0 && Pt.poly[1].coef==0) &&  Pt.poly[2].coef!=0)
			{
				str=CoefFact(Pt.poly[2].coef)+expow(Pt.poly[2].airx)+expox(Pt.poly[2].periy)+"y"+expoz(Pt.poly[2].feuillez)+expot(Pt.poly[2].compconn);
			...
			if (Pt.poly.size()==3 && (Pt.poly[0].coef!=0 && Pt.poly[1].coef==0) &&  Pt.poly[2].coef!=0)
			{
				str=CoefFact(Pt.poly[0].coef)+expow(Pt.poly[0].airx)+expox(Pt.poly[0].periy)+"y"+expoz(Pt.poly[0].feuillez)+expot(Pt.poly[0].compconn)+"+"+CoefFact(Pt.poly[2].coef)+expow(Pt.poly[2].airx)+expox(Pt.poly[2].periy)+"y"+expoz(Pt.poly[2].feuillez)+expot(Pt.poly[2].compconn);
			}
			if (Pt.poly.size()==3 && (Pt.poly[0].coef==0 && Pt.poly[1].coef!=0) &&  Pt.poly[2].coef!=0)
			{
				str=CoefFact(Pt.poly[1].coef)+expow(Pt.poly[1].airx)+expox(Pt.poly[1].periy)+"y"+expoz(Pt.poly[1].feuillez)+expot(Pt.poly[1].compconn)+"+"+CoefFact(Pt.poly[2].coef)+expow(Pt.poly[2].airx)+expox(Pt.poly[2].periy)+"y"+expoz(Pt.poly[2].feuillez)+expot(Pt.poly[2].compconn);
			}
			if (Pt.poly.size()==3 && (Pt.poly[0].coef==0 && Pt.poly[1].coef==0) &&  Pt.poly[2].coef==0)
			{
				str=" ";
...
{   
	...
	for (int i = 0; i < n; ++i)
	{
		...
		cout<<Polyn(EtatF3[i],EtatF3[n-1])<<endl;
	}
