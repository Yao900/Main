  ...
  string str,str1;
	...
	if (Pt1.poly.size()==1)
		...
		if (Pt1.poly.size()==3)
		{
		 ...
		 if (Pt.poly.size()==1 && Pt.poly[0].coef!=0)
				    {
				    	...
				    	str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")"+"*pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[0].compconn)+")";
		}
		  ...
		  if (Pt.poly.size()==2  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0)
				    {
				    	str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")*"+"pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[0].compconn)+")"+"+"+CoefFact(Pt.poly[1].coef)+"pow(w,"+to_string(Pt.poly[1].airx)+")*"+"pow(x,"+to_string(Pt.poly[1].periy)+")*y*pow(z,"+to_string(Pt.poly[1].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[1].compconn)+")";
		}
		else{
			if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 || Pt.poly[1].coef==0))
			{
		 ...
		 if (Pt.poly.size()==3  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0 && Pt.poly[2].coef!=0)
				 {
				    	str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")*"+"*pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[0].compconn)+")"+"+"+CoefFact(Pt.poly[1].coef)+"pow(w,"+to_string(Pt.poly[1].airx)+")*"+"pow(x,"+to_string(Pt.poly[1].periy)+")*y*pow(z,"+to_string(Pt.poly[1].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[1].compconn)+")"+CoefFact(Pt.poly[2].coef)+"pow(w,"+to_string(Pt.poly[2].airx)+")*"+"pow(x,"+to_string(Pt.poly[2].periy)+")*y*pow(z,"+to_string(Pt.poly[2].feuillez)+")*"+"pow(t,"+to_string(Pt.poly[2].compconn)+")";
...
{   
	...
	for (int i = 0; i < n; ++i)
	{
		...
		cout<<Polyginac(EtatF3[i],EtatF3[n-1])<<"},"<<endl;
	}
