...
bool ConpatibleMotL33(etat e1, etat e2){
     ...
     l6=BoolToInt(e1.bin[2]);
         if (BoolToInt(e2.bin[0])==0 && BoolToInt(e2.bin[1])==0 && BoolToInt(e2.bin[2])==0)
         {
         	rep=0;
         }
         else{
...
bool ConpatibleMotL32(etat e1, etat e2){
     ...
     l5=BoolToInt(e1.bin[1]);
     l6=BoolToInt(e1.bin[2]);
     if (BoolToInt(e2.bin[0])==0 && BoolToInt(e2.bin[1])==0)
         {
         	rep=0;
         }
     if (Extreme00(e1)==1)
...
bool Connexe33(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l2=BoolToInt(e2.bin[1]);
...
bool Connexe22(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l2=BoolToInt(e2.bin[1]);
...
bool Connexe11(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l4=BoolToInt(e1.bin[0]);
...
bool Connexe32(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l2=BoolToInt(e2.bin[1]);
     ...
     l5=BoolToInt(e1.bin[1]);
     l6=BoolToInt(e1.bin[2]);
     if (l1*l4 +l2*l5>0 || l1*l5 +l2*l6 >0)
     {
     	rep=1;
     }
...
bool Connexe31(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l4=BoolToInt(e1.bin[0]);
...
bool Connexe21(etat e1, etat e2){
     bool rep=0;
     int l1,l2,l3,l4,l5,l6;
     l1=BoolToInt(e2.bin[0]);
     l4=BoolToInt(e1.bin[0]);
...
bool TransPossFP3(etat e1, etat e2){
	...
	if ((e1.comppar=="{{0},{1}}" && (e2.comppar=="{{0,1}}" || e2.comppar=="{{0}}") )|| (e2.comppar=="{{0},{1}}" && e1.comppar=="{{0,1}}"))
		{
			rep=0;
		}
		
	if (ConpatibleMot(e1,e2)==0 || Connexe(e1, e2)==0)
		{
				rep=0;
...
bool MemePartieLitterale(transit t1, transit t2){
	bool rep=0;
	if (t1.airx ==t2.airx && t1.periy==t2.periy && t1.feuillez==t2.feuillez)
	{
	...
	if (Pt1.poly.size()==1)
		...
		if (Pt1.poly.size()==3)
		{
		 ...
		 if (Pt.poly.size()==1 && Pt.poly[0].coef!=0)
				    {
				    	...
				    	str =CoefFact(Pt.poly[0].coef)+expow(Pt.poly[0].airx)+expox(Pt.poly[0].periy)+"y"+expoz(Pt.poly[0].feuillez);
		}
		else{
			if (Pt.poly.size()==1 && Pt.poly[0].coef==0)
			{
		  ...
		  if (Pt.poly.size()==2  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0)
				    {
				    	str =CoefFact(Pt.poly[0].coef)+expow(Pt.poly[0].airx)+expox(Pt.poly[0].periy)+"y"+expoz(Pt.poly[0].feuillez)+"+"+CoefFact(Pt.poly[1].coef)+expow(Pt.poly[1].airx)+expox(Pt.poly[1].periy)+"y"+expoz(Pt.poly[1].feuillez);
		}
		else{
			if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 || Pt.poly[1].coef==0))
			{
		 ...
		 if (Pt.poly.size()==3  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0 && Pt.poly[2].coef!=0)
				 {
				    	str =CoefFact(Pt.poly[0].coef)+expow(Pt.poly[0].airx)+expox(Pt.poly[0].periy)+"y"+expoz(Pt.poly[0].feuillez)+"+"+CoefFact(Pt.poly[1].coef)+expow(Pt.poly[1].airx)+expox(Pt.poly[1].periy)+"y"+expoz(Pt.poly[1].feuillez)+"+"+CoefFact(Pt.poly[2].coef)+expow(Pt.poly[2].airx)+expox(Pt.poly[2].periy)+"y"+expoz(Pt.poly[2].feuillez);
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
string Polyginac(etat e1, etat e2){
  string str,str1;
     polytransit Pt, Pt1;
     Pt1=ComposanteMatriceF3(e1,e2);
     if (Pt1.poly.size()==1)
          ...
          if (Pt1.poly.size()==3)
          {
           ...
           if (Pt.poly.size()==1 && Pt.poly[0].coef!=0)
                        {
                         ...
                         str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")"+"*pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")";
          }

          else{
               if ((Pt.poly.size()==1) && ((Pt.poly[0].coef==0)||(Pt.poly[0].airx==0)))
               {
                    str="0";
               }
          }
            if (Pt.poly.size()==2  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0)
                        {
                         str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")*"+"pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")"+"+"+CoefFact(Pt.poly[1].coef)+"pow(w,"+to_string(Pt.poly[1].airx)+")*"+"pow(x,"+to_string(Pt.poly[1].periy)+")*y*pow(z,"+to_string(Pt.poly[1].feuillez)+")";
          }
          else{
               if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 || Pt.poly[1].coef==0))
               {
           ...
           if (Pt.poly.size()==3  && Pt.poly[0].coef!=0 && Pt.poly[1].coef!=0 && Pt.poly[2].coef!=0)
                     {
                         str =CoefFact(Pt.poly[0].coef)+"pow(w,"+to_string(Pt.poly[0].airx)+")*"+"pow(x,"+to_string(Pt.poly[0].periy)+")*y*pow(z,"+to_string(Pt.poly[0].feuillez)+")"+"+"+CoefFact(Pt.poly[1].coef)+"pow(w,"+to_string(Pt.poly[1].airx)+")*"+"pow(x,"+to_string(Pt.poly[1].periy)+")*y*pow(z,"+to_string(Pt.poly[1].feuillez)+")"+"+"+CoefFact(Pt.poly[2].coef)+"pow(w,"+to_string(Pt.poly[2].airx)+")*"+"pow(x,"+to_string(Pt.poly[2].periy)+")*y*pow(z,"+to_string(Pt.poly[2].feuillez)+")";
                         
                    
          }
          else{
               if (Pt.poly.size()==2 && (Pt.poly[0].coef==0 || Pt.poly[1].coef==0 || Pt.poly[2].coef==0))
               {
                    str="0";
               }
          }
...
{   
     ...
     for (int i = 0; i < n; ++i)
     {
          if (Polyginac(EtatF3[i],EtatF3[0])=="")
          {
               cout<<"{"<<"0"<<",";
          }
          else{
          cout<<"{"<<Polyginac(EtatF3[i],EtatF3[0])<<",";
          }
          for (int k = 1; k<n-1; ++k)
          {
               if (Polyginac(EtatF3[i],EtatF3[k])=="")
          {
               cout<<"0"<<",";
          }
          else{
          cout<<Polyginac(EtatF3[i],EtatF3[k])<<",";
          }  
          
          }
          if (Polyginac(EtatF3[i],EtatF3[n-1])=="")
          {
               cout<<"0"<<"},";
          }
          else{
          cout<<Polyginac(EtatF3[i],EtatF3[n-1])<<"},";
     }
     }
